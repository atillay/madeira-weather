...
async function generate() {
  ...
  await sharp(Buffer.from(svgCode)).resize(32, 32).png().toFile(path.join(publicDir, "favicon.png"));
  await sharp(Buffer.from(svgCode)).resize(192, 192).png().toFile(path.join(publicDir, "pwa-192x192.png"));
  await sharp(Buffer.from(svgCode)).resize(512, 512).png().toFile(path.join(publicDir, "pwa-512x512.png"));
